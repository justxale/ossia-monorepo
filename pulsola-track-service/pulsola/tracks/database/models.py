...
from pulsola.tracks.enum import TrackStatus, TrackVisibility
...
class Tracks(Model):
    ...
    creator: fields.ForeignKeyRelation['Creators'] = fields.ForeignKeyField(
        'pulsola.Creators', null=False, related_name='tracks'
    )
    ...
    tags: fields.ManyToManyRelation['Tags'] = fields.ManyToManyField(
        'pulsola.Tags', related_name='tracks'
    )
...
class Creators(Model):
    ...
    tags: fields.ManyToManyRelation['Tags'] = fields.ManyToManyField(
        'pulsola.Tags', related_name='creators'
    )
