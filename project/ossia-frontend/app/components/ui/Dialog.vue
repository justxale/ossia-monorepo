<template>
    ...
    >
        <template #closebutton="{ closeCallback }">
            <SecondaryButton autofocus rounded variant="text" @click="closeCallback">
                <template #icon>
                    <TimesIcon/>
                </template>
            </SecondaryButton>
        ...
        <template #maximizebutton="{ maximized, maximizeCallback }">
            <SecondaryButton autofocus rounded variant="text" @click="maximizeCallback">
                <template #icon>
...
defineProps</* @vue-ignore */ DialogProps>();
